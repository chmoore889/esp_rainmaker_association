...
class WifiStationState extends $pb.ProtobufEnum {
  static const WifiStationState Connected = WifiStationState._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'Connected');
  static const WifiStationState Connecting = WifiStationState._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'Connecting');
  static const WifiStationState Disconnected = WifiStationState._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'Disconnected');
  static const WifiStationState ConnectionFailed = WifiStationState._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ConnectionFailed');
...
class WifiConnectFailedReason extends $pb.ProtobufEnum {
  static const WifiConnectFailedReason AuthError = WifiConnectFailedReason._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'AuthError');
  static const WifiConnectFailedReason NetworkNotFound =
      WifiConnectFailedReason._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'NetworkNotFound');
...
class WifiAuthMode extends $pb.ProtobufEnum {
  static const WifiAuthMode Open = WifiAuthMode._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'Open');
  static const WifiAuthMode WEP = WifiAuthMode._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WEP');
  static const WifiAuthMode WPA_PSK = WifiAuthMode._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WPA_PSK');
  static const WifiAuthMode WPA2_PSK = WifiAuthMode._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WPA2_PSK');
  static const WifiAuthMode WPA_WPA2_PSK = WifiAuthMode._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WPA_WPA2_PSK');
  static const WifiAuthMode WPA2_ENTERPRISE = WifiAuthMode._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WPA2_ENTERPRISE');
