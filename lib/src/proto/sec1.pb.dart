...
class SessionCmd1 extends $pb.GeneratedMessage {
  ...
  factory SessionCmd1.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$pb.TagNumber(2)
  set clientVerifyData($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
...
class SessionResp1 extends $pb.GeneratedMessage {
  ...
  factory SessionResp1.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SessionResp1.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  static $pb.PbList<SessionResp1> createRepeated() =>
      $pb.PbList<SessionResp1>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set deviceVerifyData($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
...
class SessionCmd0 extends $pb.GeneratedMessage {
  ...
  factory SessionCmd0.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SessionCmd0.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$pb.TagNumber(1)
  set clientPubkey($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
...
class SessionResp0 extends $pb.GeneratedMessage {
  ...
  factory SessionResp0.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SessionResp0.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  static $pb.PbList<SessionResp0> createRepeated() =>
      $pb.PbList<SessionResp0>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set devicePubkey($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set deviceRandom($core.List<$core.int> v) {
    $_setBytes(2, v);
  }
...
class Sec1Payload extends $pb.GeneratedMessage {
  ...
  factory Sec1Payload.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Sec1Payload.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
