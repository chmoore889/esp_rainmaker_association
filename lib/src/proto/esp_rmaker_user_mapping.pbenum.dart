...
class RMakerConfigStatus extends $pb.ProtobufEnum {
  static const RMakerConfigStatus Success = RMakerConfigStatus._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'Success');
  static const RMakerConfigStatus InvalidParam = RMakerConfigStatus._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'InvalidParam');
  static const RMakerConfigStatus InvalidState = RMakerConfigStatus._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'InvalidState');
...
class RMakerConfigMsgType extends $pb.ProtobufEnum {
  static const RMakerConfigMsgType TypeCmdSetUserMapping =
      RMakerConfigMsgType._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'TypeCmdSetUserMapping');
  static const RMakerConfigMsgType TypeRespSetUserMapping =
      RMakerConfigMsgType._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
